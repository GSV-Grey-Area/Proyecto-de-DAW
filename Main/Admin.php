					...
					function Tabla(datos, nombreTabla)
					{
						...
						if (Array.isArray(datos) && datos.length > 0)
						{
							...
							for (var clave in datos[0])
							{
								...
								if (isFirstInput) {
            					input.readOnly = true; // Hacer el primer input readonly
            					isFirstInput = false; // Cambiar la variable para que solo el primer input sea readonly
        						}
							...
							celdaImagen.addEventListener("click", function() {
									InsertarProducto();
								});
